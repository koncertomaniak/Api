...
psql -h postgres -p 5432 -U test -d koncertomaniak -f data/Events.sql
psql -h postgres -p 5432 -U test -d koncertomaniak -f data/TicketProviders.sql
psql -h postgres -p 5432 -U test -d koncertomaniak -f data/EventTickets.sql
psql -h postgres -p 5432 -U test -d koncertomaniak -f data/ApiClients.sql
